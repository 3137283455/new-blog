        ...
        <div className="admin-settings-main">
          ...
          >
            <header>
              ...
              <button id="logs-refresh" className="ryu-btn btn-sm" type="button">刷新</button>
            </header>
            <div className="admin-log-summary">
              <div><small>最近24小时错误</small><strong id="logs-errors-count">—</strong></div>
              <div><small>最近24小时告警</small><strong id="logs-warnings-count">—</strong></div>
              <div><small>最近日志</small><strong id="logs-latest-at">—</strong></div>
            </div>
            <form id="memory-settings-form" className="admin-log-memory-settings">
              ...
              <label><span>普通告警</span><div className="admin-setting-unit"><input id="memory-warn-mb" className="input input-bordered" type="number" min="128" max="32768" step="1" /><span>MB</span></div></label>
              <label><span>严重参考线</span><div className="admin-setting-unit"><input id="memory-critical-mb" className="input input-bordered" type="number" min="128" max="32768" step="1" /><span>MB</span></div></label>
              <button className="ryu-btn" type="submit">保存阈值</button>
            ...
            <div className="admin-log-toolbar">
              ...
              <input id="logs-query-filter" className="input input-bordered" type="search" placeholder="搜索日志内容" />
            </div>
