...
export function NavigationPage({ links }: { links: any[] }) {
  const [query, setQuery] = useState(''); const [favorite, setFavorite] = useState(false); const [favorites, setFavorites] = useState<number[]>([]); const [category, setCategory] = useState('');
