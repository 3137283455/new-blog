...
router.get('/books/:book/document/file', libraryCtrl.documentFile)
...
router.get('/private/manga/collections', deviceAuth, mangaCtrl.privateCollections)
router.put('/private/manga/collections', deviceAuth, mangaCtrl.putCollection)
router.delete('/private/manga/collections/:id', deviceAuth, mangaCtrl.removeCollection)
...
router.get('/themes', themeCtrl.publicList)
...
router.delete('/admin/books/:id/permanent', auth, adminOnly, libraryCtrl.permanentlyRemoveBook)
...
router.get('/admin/search', auth, adminOnly, searchCtrl.adminSearch)
...
router.put('/admin/logs/policy', auth, adminOnly, logsCtrl.policy)
router.post('/admin/logs/clear', auth, adminOnly, logsCtrl.clear)
// 个人中心、收集箱与专题
...
router.get('/admin/venera-sources/export', auth, adminOnly, veneraSourceCtrl.exportConfiguration)
router.patch('/admin/venera-sources/:sourceId', auth, adminOnly, veneraSourceCtrl.toggleSource)
router.get('/admin/venera-sources/:sourceId/settings', auth, adminOnly, veneraSourceCtrl.sourceSettings)
router.put('/admin/venera-sources/:sourceId/settings', auth, adminOnly, veneraSourceCtrl.sourceSettings)
...
router.put('/admin/manga/:id/restore', auth, adminOnly, mangaCtrl.restore)
router.delete('/admin/manga/:id/permanent', auth, adminOnly, mangaCtrl.permanentlyRemove)
